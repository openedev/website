...
import { blogPostsData, sortPosts, loadBlogPostsFromStorage } from '../data/blogData';

const BlogPage = () => {
  const [blogPosts, setBlogPosts] = useState<any[]>([]);

  // Load blog posts from storage on component mount
  useEffect(() => {
    loadBlogPostsFromStorage();
    setBlogPosts(sortPosts(blogPostsData));
  }, []);
