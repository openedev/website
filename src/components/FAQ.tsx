...
const faqs = [
  ...
  },
  {
    ...
    answer: `Anywhere AI runs on a device in the real world and has to keep working: industrial inspection, robotics, automotive, and other Physical AI systems. The problem is the same everywhere: deployed AI degrades as conditions change, and self-correction keeps it accurate on the device. It is proven in production in industrial inspection today, and the same runtime extends to robotics and other edge AI systems. In robotics especially, where physical wear and model behavior affect each other, cross-layer self-correction matters most.`,
  },
  {
